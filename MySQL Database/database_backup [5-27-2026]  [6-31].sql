...
--
-- Host: 127.0.0.1
-- Generation Time: May 27, 2026 at 03:00 PM
...
INSERT INTO `propertypicture` (`ID`, `PropertyID`, `Title`, `Picture`, `Description`) VALUES
(1, 1, 'Sea View Front', NULL, 'Front view of hotel'),
(2, 2, 'Villa View', NULL, 'Mountain villa image'),
(3, 3, 'Apartment Room', NULL, 'Modern room interior'),
(4, 4, 'Resort Garden', NULL, 'Green garden area'),
(5, 5, 'Hotel Entrance', NULL, 'Royal hotel entrance');
...
INSERT INTO `property_owner` (`HotelOwnerID`, `Name`, `Phone`, `Email`, `Password`) VALUES
(50, 'Rishan Rajapaksha', '0', 'pubuth@gmail.com', '111773437422464278766'),
(53, 'Pawan', '071339938*=', 'udumbara', '123'),
(57, 'vikasitha', '0713399389', 'pawa@123@123', '123'),
(59, 'Boika', '0713399389', 'boika@gmail.com', '123');
...
--
ALTER TABLE `property_owner`
  MODIFY `HotelOwnerID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=60;
...
--
ALTER TABLE `property`
  ADD CONSTRAINT `fk_property_owner` FOREIGN KEY (`HotelOwnerID`) REFERENCES `property_owner` (`HotelOwnerID`) ON DELETE SET NULL ON UPDATE CASCADE;

--
-- Constraints for table `propertypicture`
--
ALTER TABLE `propertypicture`
  ADD CONSTRAINT `propertypicture_ibfk_1` FOREIGN KEY (`PropertyID`) REFERENCES `property` (`ID`);
COMMIT;
